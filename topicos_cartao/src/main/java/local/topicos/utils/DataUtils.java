...
public class DataUtils {
    ...
    /**
     * Retorna a data enviada por parametro com a adição dos dias desejado a
     * Data pode estar no futuro (dias > 0) ou no passado (dias < 0)
     *
     * @param data
     * @param dias
     * @return
    ...
    /**
     * Retorna a data atual com a diferenca de dias enviados por parametro a
     * Data pode estar no futuro (parametro positivo) ou no passado (parametro
     * negativo)
     *
    ...
    /**
     * Retorna uma instância de <code>Date</code> refletindo os valores passados
     * por parametro
     *
     * @param dia
     * @param mes
