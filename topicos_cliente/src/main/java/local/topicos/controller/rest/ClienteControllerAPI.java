...
import local.topicos.dao.ClienteDAO;
...
public class ClienteControllerAPI {
    ...
    // -------------------Retrieve  Usuario CPF------------------------------------------

    @RequestMapping(value = "/clienteCPF/{cpf}", method = RequestMethod.GET)
    public ResponseEntity<?> getCliente(@PathVariable("cpf") String cpf) {

        Cliente cliente = clienteDAO.encontrarClienteCpf(cpf);
        if (cliente == null) {
